...
open class AppRepository constructor(
    ...
    override fun fetchCategories(
        ...
        page: Int,
        limit: Int
    ): Observable<BaseResponse<BasePagination<List<Category>>>> = api.fetchCategories(querySearch,page,limit)
    ...
    override fun fetchCategories(
        ...
        page: Int,
        limit: Int
    ): Observable<BaseResponse<BasePagination<List<Category>>>> = api.fetchCategories(productPresent,parentId,page,limit)

    override fun getProductsByCategoryId(categoryId: Int): Observable<BaseResponse<BasePagination<List<Product>>>> = api.getProductsByCategoryId(categoryId)
