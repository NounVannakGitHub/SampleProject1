...
import kh.com.wbfinance.vannak.sampleproject1.databinding.FragmentDailyDataListBinding
...
class DailyDataListFragment : BaseFragment() {
    ...
    lateinit var binding: FragmentDailyDataListBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDailyDataListBinding.inflate(inflater, container, false)
        return binding.root
    }
